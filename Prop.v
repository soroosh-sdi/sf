...
Proof.
  intros.
  simpl.
  apply (b_sum n (n + 0) H (b_sum n 0 H b_0)).
Qed.
...
Print gorgeous.
Definition gorgeous_plus13_proof: forall n, gorgeous n -> gorgeous (13+n) :=
  fun n => fun H : gorgeous n =>
    g_plus3 (10+n) (g_plus5 (5+n) (g_plus5 n H)).
Theorem gorgeous_plus13: forall n, 
  gorgeous n -> gorgeous (13+n).
Proof.
  apply gorgeous_plus13_proof.
  Qed.
...
Proof.
   ...
   induction H.
   simpl. apply g_0.
   rewrite helper_g_times2 with (x:=n) (y:=0) (z:=n) in IHgorgeous.
      (* FILL IN HERE *) Admitted.
(** [] *)
